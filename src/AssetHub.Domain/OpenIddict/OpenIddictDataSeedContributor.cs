...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AssetHub") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AssetHub", DisplayName = "AssetHub API", Resources = { "AssetHub" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["AssetHub_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["AssetHub_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["AssetHub_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["AssetHub_Swagger:RootUrl"]?.TrimEnd('/');
        ...
        string? logoUri = null)
    {
        ...
        foreach (var grantType in grantTypes)
        {
            ...
            if (grantType == OpenIddictConstants.GrantTypes.DeviceCode)
            {
                ...
                //application.Permissions.Add(OpenIddictConstants.Permissions.Endpoints.DeviceCode);
            }
